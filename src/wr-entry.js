...
async function loadOS(){
  if(!osPromise){
    osPromise=Promise.all([
      import('./wr-receiving-os-v10.js?v=20260909-v10d'),
      import('./wr-media-components-v9.js?v=20260909-v10d').catch(e=>{console.warn('WR media component unavailable',e);return null}),
      import('./wr-document-scanner-v9b.js?v=20260909-v10d').catch(e=>{console.warn('WR scanner unavailable',e);return null}),
      import('./wr-signature-component-v9.js?v=20260909-v10d').catch(e=>{console.warn('WR signature unavailable',e);return null}),
      import('./wr-os-guard-v10.js?v=20260909-v10d').catch(e=>{console.warn('WR guard unavailable',e);return null})
    ]).then(([os])=>os);
  }
  return osPromise;
}
...
// Capture every warehouse receive entry point before legacy onclick handlers can run.
...
// Defensive takeover: live-app.js still contains the original prototype route.
// If any older handler paints that screen, immediately replace it with the canonical workspace.

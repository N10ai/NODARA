...
window.nodaraFTZ={list,config:configScreen,newAdmission:createScreen,detail,createReceipt:createReceiptForAdmission,linkReceipt:linkReceiptScreen,reconcile,postInventory,auditTrail};
